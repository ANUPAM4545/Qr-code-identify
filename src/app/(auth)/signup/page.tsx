  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-zinc-500 font-medium">Start managing enterprise events today</p>
      </div>
      ...
      <p className="text-[11px] text-center text-zinc-500 mt-4 px-4 font-medium leading-relaxed">
        By clicking continue, you agree to our{" "}
        <Link href="/terms" className="text-zinc-900 font-bold hover:underline decoration-zinc-300 underline-offset-4">Terms of Service</Link>{" "}
        and{" "}
        <Link href="/privacy" className="text-zinc-900 font-bold hover:underline decoration-zinc-300 underline-offset-4">Privacy Policy</Link>.
      </p>

      <p className="text-sm font-medium text-center text-zinc-500 mt-2">
